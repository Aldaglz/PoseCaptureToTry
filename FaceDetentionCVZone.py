...
#Initialie the webcam and set it to the the third camera (index 2)
...
#Loop to continuosly get frames form the webcam
while True:
    ...
    #Wait for the 1 millisecond between each frame
    cv2.waitKey(1)
